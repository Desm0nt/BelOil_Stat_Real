...
namespace WindowsFormsApp1
{
    ...
    public class OutlookGridObjectGroup : OutlookGridDefaultGroup
    {
        ...
        public OutlookGridObjectGroup() : base()
        {
        ...
        public OutlookGridObjectGroup(IOutlookGridGroup parentGroup) : base(parentGroup)
        {
            AllowHiddenWhenGrouped = false;
            _currency = CultureInfo.CurrentCulture.NumberFormat.CurrencySymbol;
        }
        ...
        {
            var a = ProfileForm.elList.FirstOrDefault(n =>n.Id==priceCode); ;
            string name = a.Name;
            return name;
        }
        ...
        {
            OutlookGridObjectGroup gr = new OutlookGridObjectGroup(this.ParentGroup);
        ...
        public override int CompareTo(object obj)
        {
            ...
            if (obj is OutlookGridObjectGroup)
            {
                priceOther = ((OutlookGridObjectGroup)obj)._priceCode;
            }
            else
            {
                priceOther = noPrice;
