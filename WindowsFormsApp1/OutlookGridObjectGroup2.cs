...
namespace WindowsFormsApp1
{
    ...
    public class OutlookGridObjectGroup2 : OutlookGridDefaultGroup
    {
        ...
        public OutlookGridObjectGroup2() : base()
        {
        ...
        public OutlookGridObjectGroup2(IOutlookGridGroup parentGroup) : base(parentGroup)
        {
            AllowHiddenWhenGrouped = false;
            _currency = CultureInfo.CurrentCulture.NumberFormat.CurrencySymbol;
        }
        ...
        {
            var a = ReportsForm.elLists.FirstOrDefault(n =>n.Id==priceCode);
            string name = a.Name;
            return name;
        }
        ...
        {
            OutlookGridObjectGroup2 gr = new OutlookGridObjectGroup2(this.ParentGroup);
        ...
        public override int CompareTo(object obj)
        {
            ...
            if (obj is OutlookGridObjectGroup2)
            {
                priceOther = ((OutlookGridObjectGroup2)obj)._priceCode;
            }
            else
            {
                priceOther = noPrice;
