...
namespace WindowsFormsApp1
{
    ...
    public class OutlookGridPersonGroup3 : OutlookGridDefaultGroup
    {
        ...
        public OutlookGridPersonGroup3() : base()
        {
        ...
        public OutlookGridPersonGroup3(IOutlookGridGroup parentGroup) : base(parentGroup)
        {
            AllowHiddenWhenGrouped = false;
            _currency = CultureInfo.CurrentCulture.NumberFormat.CurrencySymbol;
        }
        ...
        {
            var a = ReportsForm.CompanyIdList.FirstOrDefault(n => n.Id==priceCode); ;
            string name = a.Name;
            return name;
        }
        ...
        {
            OutlookGridPersonGroup3 gr = new OutlookGridPersonGroup3(this.ParentGroup);
        ...
        public override int CompareTo(object obj)
        {
            ...
            if (obj is OutlookGridPersonGroup3)
            {
                priceOther = ((OutlookGridPersonGroup3)obj)._priceCode;
            }
            else
            {
                priceOther = noPrice;
