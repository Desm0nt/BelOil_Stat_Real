...
namespace WindowsFormsApp1
{
    public partial class ReportsCreateForm : KryptonForm
    {
        ...
        private string CheckHeatResult()
        {
            string result = "";
        ...
        private string CheckElResult()
        {
            ...
            if (b == final)
                ...
                result = "Электричество: Выработано " + src + ", получено " + rec + ", отдано " + send + ", всего - " + b + ", а указано " + final;
        ...
        {
            string resultHeat = CheckHeatResult();
            string resultEl = CheckElResult();

            if (resultHeat == "OK" && resultEl == "OK")
            {
            ...
            else if (resultHeat != "OK")
                MessageBox.Show(resultHeat);
            else if (resultEl != "OK")
                MessageBox.Show(resultEl);
        }
