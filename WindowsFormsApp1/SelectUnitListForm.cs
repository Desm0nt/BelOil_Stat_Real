...
{
    public partial class SelectUnitListForm : KryptonForm
    {
        ...
        private void kryptonButton1_Click(object sender, EventArgs e)
        {
            if (kryptonOutlookGrid1.SelectedRows.Count > 0)
            {
                ...
                {
                    unit_id = Int32.Parse(kryptonOutlookGrid1.SelectedRows[0].Cells[0].Value.ToString());
                    unit_name = kryptonOutlookGrid1.SelectedRows[0].Cells[3].Value.ToString();
